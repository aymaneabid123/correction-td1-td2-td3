...
class Patron extends Employe {
    ...
    public double gains() {
       ...
       public String toString() {
        return "Nom : " + getNom() + ", Prénom : " + getPrenom() + salaire;
    }
}
...
public class ex7 {
    public static void main(String[] args) {
        Patron patron = new Patron("ALawi", "Ahmed", 5000.0);
        TravailleurCommission travailleurCommission = new TravailleurCommission("Yauobi", "Ilyas", 2000.0, 15.0);
        TravailleurHoraire travailleurHoraire = new TravailleurHoraire("Hajji", "Samir", 30.0);

        travailleurCommission.setQuantite(70);
        travailleurHoraire.setHeures(120);
